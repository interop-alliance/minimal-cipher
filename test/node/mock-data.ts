...
export const key1Data = {
  id:
    'did:key:z6MkwLz9d2sa3FJjni9A7rXmicf9NN3e5xgJPUmdqaFMTgoE#' +
...
export const key2Data = {
  id:
    'did:key:z6MkttYcTAeZbVsBiAmxFj2LNSgNzj5gAdb3hbE4QwmFTK4Z#z6LSjPQz1GAR' +
...
export const fipsKey1Data = {
  ...
  id:
    'did:key:zDnaey9HdsvnNjAn2PaCXXJihjNsiXWzCvRS9HgEbcjPqvPNY#' +
...
export const fipsKey2Data = {
  '@context': 'https://w3id.org/security/multikey/v1',
  id:
    'did:key:zDnaeX3DFUeCwF6dvvXnewsLtumrDFRu8bquxi96FZ6A5dd7b#' +
